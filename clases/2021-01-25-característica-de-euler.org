...
También vimos triangulaciones de la esfera, como el octaedro y el icosaedro, y algunas triangulaciones no regulares, y todas ellas tuvieron característica de Euler igual a 1. Concluimos que el valor de la característica de Euler depende más de la /forma/
 que de la /métrica./
